...
public:
    ...
    struct Iterator
    {
        ...
        friend bool operator!= (const Iterator& a, const Iterator& b) { return a.m_ptr != b.m_ptr; };
        friend bool operator== (const Iterator& a, const T& b) { return *a.m_ptr == b; }
        friend bool operator!= (const Iterator& a, const T& b) { return *a.m_ptr != b; };
    ...
    struct rit
    {
        ...
        rit(pointer ptr) : m_ptr(ptr) {};

        reference operator*() const { return *m_ptr; }
        pointer operator->() { return m_ptr; }
        rit& operator++() { m_ptr++; return *this; }
        rit operator++(int) { rit tmp = *this; ++(*this); return tmp; }
        friend bool operator== (const rit& a, const rit& b) { return a.m_ptr == b.m_ptr; };
        friend bool operator!= (const rit& a, const rit& b) { return a.m_ptr != b.m_ptr; };
        friend bool operator== (const rit& a, const T& b) { return *a.m_ptr == b; }
        friend bool operator!= (const rit& a, const T& b) { return *a.m_ptr != b; };

        rit& operator= (const rit& r){ m_ptr = r.m_ptr; return *this; }
        rit& operator= (const T& r){ *m_ptr = r; return *this; }
        rit& operator--() { m_ptr--; return *this; }
        rit operator--(int) { rit tmp = *this; --(*this); return tmp; }
        rit& operator+ (int i) { m_ptr + i; return *this; }
        rit& operator- (int i) { m_ptr - i; return *this; }
        bool operator< (const rit& r) { return *m_ptr < *(r.m_ptr); }
        bool operator> (const rit& r) { return *m_ptr > *(r.m_ptr); }
        T& operator[] (int l){
            return *(m_ptr + l);
        }

        friend std::ostream& operator<< (std::ostream& o, const rit& i){
            o << *i.m_ptr;
            return o;
        }
    ...
    //iterator begin and end
    rit rbegin() {return rit(data);}
    rit rend() {return rit(&data[this->size]);}
